...
const WalletListaCobrancasRecebidas = ({ title, changePath, ...rest }) => {
  ...
  useEffect(() => {
    dispatch(loadCobrancasRecebidasWallet(token, page, like, order, mostrar));
...
export default WalletListaCobrancasRecebidas;
