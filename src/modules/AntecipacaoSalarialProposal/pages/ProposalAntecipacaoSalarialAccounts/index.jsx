									...
									{filters.tipo === '2' && (
										...
										>
											...
											<Popover buttonContent={<InfoOutlined />}>
												...
												>
													Lista de Funcionários que já foram
											...
											<Popover buttonContent={<InfoOutlined />}>
												...
												>
													Se este botão está ativo, significa que a
													emprea já foi liberada para utilizar a
													Proposta de Antecipação Salarial, assim
													como todos os seus funcionários.
												</Typography>
												<Typography
													variant="body2"
													style={{
												...
												>
													Remover a empresa (conta PJ) da Proposta
													de Antecipação Salarial, fará com que
													seus funcionários não possam mais
													solicitar essa Antecipação Salarial, a
													não ser que seja feita a liberação para o
													funcionário em especifico.
												</Typography>
											</Popover>
										</Box>
									)}
