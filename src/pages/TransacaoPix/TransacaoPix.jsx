...
const TransacaoPix = () => {
	...
	const columns = [
		...
		},
		{
			...
			// CustomValue: (tipo) => {
			// 	if (tipo === '0') {
			// 		return <Typography>CPF</Typography>;
			// 	}
			// 	if (tipo === '1') {
			// 		return <Typography>CNPJ</Typography>;
			// 	}
			// 	if (tipo === '2') {
			// 		return <Typography>E-mail</Typography>;
			// 	}
			// 	if (tipo === '3') {
			// 		return <Typography>Celular</Typography>;
			// 	}
			// 	if (tipo === '4') {
		...
		<Box className={classes.root}>
			...
			<Box className={classes.headerContainer}>
				...
				<Box className={classes.tableContainer}>
					{pagamentoPix.data && pagamentoPix.per_page ? (
