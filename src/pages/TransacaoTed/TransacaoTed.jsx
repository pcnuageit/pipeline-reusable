...
const TransacaoTed = () => {
	...
	const columns = [
		...
		},
		{
			...
			FullObject: (data) => (
				<Typography>
					{data.conta_model.tipo === 'Pessoa Jurídica'
						? data.conta_model.razao_social
						: data.conta_model.nome}
				</Typography>
			),
		},
		{
			...
			FullObject: (data) => (
				<Typography>
					{data.conta_model.tipo === 'Pessoa Jurídica'
						? data.conta_model.cnpj
						: data.conta_model.tipo === 'Pessoa física'
						? data.conta_model.documento
						: null}
				</Typography>
			),
		},
